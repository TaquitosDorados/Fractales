...
//     version 1.19.0
//     from Assets/Garza/Zoom Padre/ZoomPadre.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Garza/Zoom Padre/ZoomPadre.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @ZoomPadre: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ~@ZoomPadre()
    {
        UnityEngine.Debug.Assert(!m_Zoom.enabled, "This will cause a leak and performance issues, ZoomPadre.Zoom.Disable() has not been called.");
    }
    ...
    {
        private @ZoomPadre m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public ZoomActions(@ZoomPadre wrapper) { m_Wrapper = wrapper; }
        /// <summary>
